  ...
  submitForm(): void {
    ...
    if (this.selectedDataModelID){
      if (this.selectedFileType === 'json'){
        this.dataModelService.updateDataModelFromJson(this.selectedDataModelID, this.file)
        ...
        this.dataModelService.updateDataModelFromExcel(this.selectedDataModelID, this.file, version, longitudinal)
      }
    }
