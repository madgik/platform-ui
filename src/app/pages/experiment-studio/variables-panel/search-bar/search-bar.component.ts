...
export class SearchBarComponent implements OnInit, OnChanges {
  ...
  ngOnInit(): void {
    ...
    console.log(this.dataModelHierarchy);
    if (this.dataModelHierarchy) {
      console.log("✅ Data Model Hierarchy found:", this.dataModelHierarchy);
...
ngOnChanges(changes: SimpleChanges): void {
  if (changes['dataModelHierarchy']?.currentValue) {
    console.log("🔄 Search Bar Received New Data Model Hierarchy:", changes['dataModelHierarchy'].currentValue);
    ...
    console.log("✅ Extracted Variables in Search Bar:", this.variables);
    console.log("✅ Extracted Groups in Search Bar:", this.groups);
  } else {
